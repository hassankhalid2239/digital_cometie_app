                          ...
                          child: Stack(
                            children: [
                              Center(
                                child: CircleAvatar(
                                  radius: 25,
                                  backgroundImage: _cometieController
                                                  .members[index]
                                              ['memberProfilePic'] ==
                                          ''
                                      ? const AssetImage(
                                          'assets/images/pfavatar.png')
                                      : NetworkImage(_cometieController
                                              .members[index]['memberProfilePic'])
                                          as ImageProvider,
                                ),
                              ),
                              Align(
                          ...
                          return FadeAnimation2(
                            ...
                            ListTile(
                              onTap: () {
                                ...
                                if (isAlreadyAdded) {
                                  Utils().showToastMessage('User Already Added');
                                } else if (_cometieController.members.length ==
                                    _stateController.currentValue.round()) {
                                  Utils().showToastMessage(
                                      'Only ${_stateController.currentValue.round()} members allowed!');
                                } else {
                                  _cometieController.members.add({
                                    'memberUid': snapshot.data.docs[index]['uid'],
                                    'memberName': snapshot.data.docs[index]
                                        ['name'],
                                    'memberPhone': snapshot.data.docs[index]
                                        ['phone'],
                                    'memberProfilePic': snapshot.data.docs[index]
                                        ['profilePic'],
                                  });
                                }
                              },
