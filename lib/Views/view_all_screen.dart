                    ...
                    children: [
                      Obx((){
                        return CustomElevatedButton(
                            title: 'All',
                            onTap: () {
                              _stateController.viewAllFilterIndex.value=0;
                            },
                            bgColor: const Color(0xffE9F0FF),
                            titleColor: Colors.black,
                            borderColor: _stateController.viewAllFilterIndex.value==0?
                      ...
                      Obx((){
                        return CustomElevatedButton(
                            title: 'Month',
                            onTap: () {
                              _stateController.viewAllFilterIndex.value=1;
                            },
                            bgColor: const Color(0xffE9F0FF),
                            titleColor: Colors.black,
                            borderColor: _stateController.viewAllFilterIndex.value==1?
                            const Color(0xff003CBE):Colors.transparent
                        );
                      }),
                       SizedBox(
                      ...
                      Obx((){
                        return  CustomElevatedButton(
                            title: 'Location',
                            onTap: () {
                              _stateController.viewAllFilterIndex.value=2;
                            },
                            bgColor: const Color(0xffE9F0FF),
                            titleColor: Colors.black,
                            borderColor: _stateController.viewAllFilterIndex.value==2?
                            const Color(0xff003CBE):Colors.transparent
                        );
                      })
                    ],
                  ...
                  child: Padding(
                      ...
                      child: Obx((){
                        return StreamBuilder(
                          stream: CometieController().viewAllCometies(),
